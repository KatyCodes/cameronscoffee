 ...
 */
function mystyle_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['mystyle_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('mystyle sample setting'),
  '#default_value' => theme_get_setting('mystyle_example'),
